...
const Task: React.FC<{
    ...
    check: () => void,
    retry: () => void
}> = ({complete, lives, i, maxQ, children, disabled, feedback, answer, score, instruction, next, check, retry}) => {
    ...
    return (
        <TaskContainer>
            ...
            {! complete && <Fragment>
                <StyledTask>
                    <TaskHeader lives={lives} i={i} maxQ={maxQ} instruction={instruction} />
                    { children }
                </StyledTask>
